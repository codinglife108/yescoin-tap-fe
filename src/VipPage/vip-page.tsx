    ...
    return (
        <div className='VipPage--playerRow'>
            <div className='VipPage--playerInfo'>
                <div
                    className={
                        'team-image-container small flex justify-center items-center relative'
                    }
                >
                    ...
                    <span className='VipPage--rank absolute bottom-[-10px] right-[-10px] text-[20px]'>
                        {getRankIcon(rank)}
                    </span>
                </div>
                <div className={'flex flex-col'}>
                    ...
                    <div className='VipPage--playerStats'>
                        <span className='VipPage--miners'>
                            {invite_count} {t('vipInvitesLabel')}
                        </span>
                        <IconText
                            size='small'
...
export default function VipPage() {
    ...
    const loadMorePlayers = () => {
        setVisiblePlayers((prevVisible) =>
            Math.min(prevVisible + 20, leaderboardData.length)
        )
    }
    ...
    return (
        <Panel>
            ...
            <div className='VipPage--content'>
                ...
                />
                <h1 className='VipPage--heading text-[24px]'>
                    Top 100 Leaders
                </h1>
