...
function InformationModal({
    ...
    const { title, value, level, icon, Description, boostDescription } =
        itemData
    ...
    return (
        <div
            className={`boost-confirmation--container ${
                floatingCenter ? 'floating-center' : ''
            }`}
            onClick={handleClose}
        >
            <div
            ...
            >
                ...
                {title && (
                    <p
                        className={`text-center font-bold ${
                            floatingCenter ? 'text-2xl' : 'text-3xl'
                        }`}
                    >
                        {title}
                    </p>
                ...
                <Button
                    ...
                    disabled={disabled}
                    style={{
                        minHeight: floatingCenter ? 50 : isBoost ? 50 : 'unset',
                    }}
                    onClick={() => {
                        callback()
