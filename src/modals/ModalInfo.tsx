...
tg.openLink("https://partner.bybit.com/b/yeswsot");
    ...
    const icon = activeModalParams['icon']?activeModalParams['icon'] : logoBonus;
    ...
    return (
        <>
            <InformationModal
                floatingCenter ={modalType == ModalTypes.VOTE_YESCOIN || modalType == ModalTypes.CONNECT_WALLET}
                modalType = {modalType}
                ...
                itemData={{
                    icon: <img src={icon} className={iconClass} alt={"modal-from-bottom"}/>,
                    title,
