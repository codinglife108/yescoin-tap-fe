...
// @ts-ignore
import animationData from '../../assets/lottery/USDT.json';
import {AnimationComponent} from "./InterfacesAndConstants";



const UsdtAnimation = ({framesPlayedRate, loop = true, canPlay = true}: AnimationComponent) => {
