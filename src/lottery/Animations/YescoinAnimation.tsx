...
// @ts-ignore
import animationData from '../../assets/lottery/YESCOIN.json';
import {AnimationComponent} from "./InterfacesAndConstants";



const YescoinAnimation = ({framesPlayedRate, loop = true, canPlay = true}: AnimationComponent) => {
...
export default YescoinAnimation;