...
import {AnimationTags, ROTATING_STAR, WHEEL_BASE} from "./Animations/InterfacesAndConstants";
...
const LotteryModal: React.FC<LotteryModalProps> = ({isOpen, onClose}) => {
    ...
    const pages: Page[] = [
        {
            title: "What is this?",
            content: "Welcome to the Wheel of Luck. Spin it to win Telegram Premium, the cryptocurrency TON, and in-game bonuses!",
            animation: ROTATING_STAR
        },
        {
            title: "How to Play",
            content: "Simply spin the wheel and see what prize you win! It's that easy!",
            animation: WHEEL_BASE
        },
        {
            title: "Prizes",
            content: "Win amazing prizes including Telegram Premium, TON cryptocurrency, and special in-game bonuses!",
            animation:  ROTATING_STAR
        },
        {
            title: "Ready?",
        ...
        <div className="Modal-Lottery--overlay">
            <div className="Modal-Lottery--container">
                ...
                <div className="Modal-Lottery--content">
                    <div className="Modal-Lottery--pages-container" ref={containerRef}>
                        {pages.map((page, index) => (
                            <div key={index} className="Modal-Lottery--page">
                                <div className="Modal-Lottery--image-container">
                                    {page.animation ? getAnimationFromTag(page.animation) : (
                                        <img
                                            src={page.image}
                                            alt={page.title}
                    ...
                    {currentPage > 0 && (
                        <button className="Modal-Lottery--arrow Modal-Lottery--arrow-left" onClick={prevPage}>
                    ...
                    {currentPage < totalPages - 1 && (
                        <button className="Modal-Lottery--arrow Modal-Lottery--arrow-right" onClick={nextPage}>
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="Modal-Lottery--footer">
                    <button onClick={nextPage} className="Modal-Lottery--next-button btn-gradient">
