...
const CountdownToDate: FC<CountdownToDateProps> = ({ targetDate }) => {
    ...
    return (
        <div className='CountdownToDate--coutndown-container'>
            ...
            <h2 className='CountdownToDate--coutndown-title'>
            ...
            <div className='CountdownToDate--coutndown-wrapper'>
                {Object.keys(timeLeft).map((interval) => (
                    <span
                        key={interval}
                        className='CountdownToDate--coutndown-block'
                    >
                        <span className='CountdownToDate--coutndown-number'>
                            {(timeLeft as any)[interval]}
                        </span>
                        <span className='CountdownToDate--coutndown-text'>
                            {interval}
                        </span>
                    </span>
                ))}
