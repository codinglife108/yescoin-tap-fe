...
const TaskConnectWallet: FC<TaskConnectWalletProps> = ({
    taskId,
    reward,
    isCompleted,
    icon,
    ...
    return (
        <div onClick={clickHandler} className={`step-card`}>
            <Cell
                key='connectWallet'
                superTask={true}
            ...
            >
                {tonConnectUI.connected || isCompleted ? (
                    tonConnectUI.connected ? (
                        'wallet connected: ' + readableAddress()
                    ) : (
                        'connect again'
                    )
                ) : (
