...
const ScreenLoader: FC<ScreenLoaderProps> = ({ content }) => {
    ...
    const openMigrationBot = () => {
        ...
        // @ts-ignore
        tg.openTelegramLink(`https://t.me/realyescoinbot?start}`)
        ...
        content && (
            ...
            >
                {content === 'maintainance' && (
                    <>
                        <div
                            className='ScreenLoader--content'
                            style={{ marginTop: '5vh' }}
                        >
                            ...
                            >
                                We are working on something, come back in 30
                                min.
                            </h2>
                        </div>
                    </>
                ...
                {content === 'botMigration' && (
                    <>
                        ...
                        >
                            {/*<Img src={require('../../assets/images/qr.png')} />*/}
                            <h1 className='ScreenLoader--content-bot-migration-text'>
                                Yescoin has now moved to @realyescoinbot. Keep
                                playing here👇
                            </h1>
