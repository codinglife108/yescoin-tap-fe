...
import VipPage from './panels/VipPage/vip-page'
...
const App: FC = () => {
    ...
    useEffect(() => {
        ...
        debouncedDispatchEnergy,
        selector.energyLeft,
        isInitialized,
        selector.dailyEnergy,
    ])
        ...
        <>
            ...
            <BrowserRouter>
                <Routes>
                    ...
                    <Route
                        path={ROUTE_LOG_OF_LUCK}
                        element={<LogsOfLuckList />}
                    />
                    <Route
                        path={ROUTE_LOG_OF_LUCK_DETAIL}
                        element={<LogsOfLuck />}
                    />
            ...
            <>
                ...
                {showBonusMalusModal && bonusMalusValue > 0 && (
                    <BonusMalus
                        bonusMalusValue={bonusMalusValue}
                        onClose={() => setShowBonusMalusModal(false)}
                    />
                )}
