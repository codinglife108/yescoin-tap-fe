...
const useModal = () => {
    ...
    if (
        activeModalParams &&
        activeModalParams.hasOwnProperty('additional_info') &&
        activeModalParams['additional_info'] !== null &&
        activeModalParams['additional_info'] !== ''
    ) {
        if (typeof activeModalParams['additional_info'] === 'string') {
            activeModalParams['additional_info'] = JSON.parse(
                activeModalParams['additional_info']
            )
        }
    }
