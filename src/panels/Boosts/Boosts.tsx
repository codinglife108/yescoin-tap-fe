...
const Boosts: FC = () => {
    ...
    const buy = async (boost: any, withRockets?: boolean) => {
        ...
        if (withRockets) {
            dispatch(
                getDispatchObject(REDUCE_ROCKET, boost['updateCostRocket'])
            )
        } else {
                    ...
                    <Cell
                        ...
                        before={
                            <EmojiRectangle>
                                <Img
                                    src={require(
                                        `../../assets/images/emoji/lightning.png`
                                    )}
                                />
                            </EmojiRectangle>
                        }
                        ...
                        <Cell
                            ...
                            before={
                                <EmojiRectangle>
                                    <Img
                                        src={require(
                                            `../../assets/images/emoji/${boost.emoji}.png`
                                        )}
                                    />
                                </EmojiRectangle>
                            }
                    ...
                    itemData={{
                        ...
                        icon: (
                            <Img
                                ...
                                src={require(
                                    `../../assets/images/emoji/${selectedBoost?.icon}_big.png`
                                )}
                            />
                        ),
                    }}
