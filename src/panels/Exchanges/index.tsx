...
const Exhchanges: FC = () => {
    ...
    const tasksOfExchanges = campaigns?.filter(
        (campaign: any) => campaign.sectiontype == 'exchanges'
    )
    ...
    const _renderHeader = () => {
        return (
            <div className='flex flex-col justify-center items-center mt-[20px] w-full '>
                ...
                <div className='mt-1 text-[24px] text-gray-400'>
                    Probably something
                </div>
            </div>
        )
    ...
    const _renderWalletConnect = () => {
        ...
        return (
            <div
                className='bg-[#FFFFFF1F] p-1 px-4 mt-4 rounded-[16px] flex items-center gap-4'
                onClick={
            ...
            >
                ...
                {okxContext.walletAddress && isWalletRewarded ? (
                    <div className='w-full flex justify-between items-end text-[20px]'>
                        Wallet
                        <p className='text-gray-400 text-[18px]'>
                            {readableAddress(okxContext.walletAddress || '')}
                        </p>
                    </div>
                ) : (
                    <>
    ...
    const handleDocClick = () => {
        dispatch(
            getDispatchObject(SET_TOAST, {
                open: true,
                message: (
                    <p className='whitespace-nowrap'>👀 Snapshot coming</p>
                ),
                type: 'noicon',
            })
        )
