...
import {ROUTE_BOOSTS, ROUTE_FRIENDS, ROUTE_TASKS, ROUTE_EXCHANGES, ROUTE_LOTTERY} from "../../../../routes";
...
const Navigation: FC<NavigationProps> = () => {
    ...
    return (
        <Tabbar>
            ...
            />
            <Tab
                icon={<Img radius={0} src={require('../../../../assets/icons/exclamation_gift_box.png')} />}
