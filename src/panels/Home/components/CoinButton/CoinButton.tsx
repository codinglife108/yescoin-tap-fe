  ...
  const click = (event: any) => {
    if (isDesktop()) {
      setActiveModal(MODAL_INFO, {
        ...
        title: "We are Sorry!",
        buttonText: "Sure!",
        description: () => <p>But you can only tap on a mobile device!</p>,
      });
      return;
    }
  ...
  const handleVoteYescoinModal = async() => {
    setModalType(ModalTypes.VOTE_YESCOIN);
      ...
      setActiveModal(MODAL_INFO, {
        ...
        description: () => <p className="font-bold text-[20px] text-center">Help Yescoin get listed on<br/> Bybit! Your vote in the BYBIT<br/> WSOT event brings us one <br/>step closer to this major <br/>mileston, and you could even<br/> win a share of the 1M MNT<br/>prize pool !</p>,
      });
  }
