...
const Home = ({ fetchUserInfo, isInitialized, taskUrl }: { fetchUserInfo?: () => Promise<void>, isInitialized: boolean, taskUrl: string | null }) => {
    ...
    return (
        <Panel>
            ...
            <TopInfo onClick={() => navigate(ROUTE_VIP_PAGE)} extraStyle={{ background: "#1f1f1f", padding: 16, display: 'flex', justifyContent: 'center', paddingTop: 8, paddingBottom: 8, gap: 30, alignItems: 'center', fontSize: 18, fontWeight: 600, cursor: 'pointer' }} />
            {/* <MyTeamButton /> */}
