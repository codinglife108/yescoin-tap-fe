        ...
        <Panel>
            <PaneledBackground>
                ...
                <BackgroundGlow
                    ...
                    vertical='bottom'
                />
                <Placeholder title={t('teamSettingsTitle')} />
                ...
                <>
                    <Input
                        ...
                        value={nameInput}
                        onChange={(event) =>
                            teamFormChange('name', event, setNameInput)
                        }
                    />
                    ...
                    <div className={'flex items-center w-full gap-1'}>
                        <Button
                            onClick={() => {
                                setFeedbackText(
                                    'Are you sure you want leave your current team to join another one? Remember, if you are the owner of your current team, once you leave it, you will no longer be the owner.'
                                )
                        ...
                        <Button
                            onClick={() => {
                                setFeedbackText(
                                    'Are you sure you want to delete your team to? Remember, this action cannot be undone.'
                                )
                                setOpenFeedbackModal(true)
