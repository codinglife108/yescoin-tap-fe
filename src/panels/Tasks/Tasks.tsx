...
const Tasks: FC = () => {
    ...
    const [adsgramAdStatus, setAdsgramAdStatus] = useState<AdsgramAdStatus>(
    ...
    const fetch = async () => {
        ...
        const responseDailyReward = await fetchData(
            '/tasks/getDailyFixedReward'
        )
    ...
    const renderAdsgramAdReward = () => {
        return (
            <Cell
                ...
                title={`Watch an Ad`}
                after={
                    adsgramAdStatus === AdsgramAdStatus.AVAILABLE && (
                        <Icon16Chevron />
                    )
                }
